            ...
            <div className="flex flex-col sm:flex-row justify-between items-center p-2 sm:p-4 w-full max-w-6xl mx-auto">
                ...
                <nav className={`w-full sm:w-auto ${menuOpen ? '' : 'hidden'} sm:block`}>
                    <ul className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4 bg-white sm:bg-transparent p-4 sm:p-0 rounded-lg shadow sm:shadow-none">
                        <li className="font-bold text-base sm:text-lg font-serif">Online Status: {onlineStatus ? "🟢" :"🔴"}</li>
                        <li className="font-bold text-base sm:text-lg font-serif"> <Link className="link" to='/'>Home</Link></li>
                        <li className="font-bold text-base sm:text-lg font-serif"> <Link className="link" to='/about'>About Us</Link></li>
                        <li className="font-bold text-base sm:text-lg font-serif"> <Link className="link" to='/contactus'>Contact</Link></li>
                        <li className="font-bold text-base sm:text-lg font-serif"> <Link className="link" to='/grocery'>Grocery</Link></li>
                        <li className="font-bold text-base sm:text-lg font-serif"> <Link className="link" to='/cart'>Cart</Link></li>
                        <li>
                        ...
                        <li className="font-bold text-base sm:text-lg font-serif">{data.loggedInUser}</li>
                    </ul>
                </nav>
            </div>
        </header>
