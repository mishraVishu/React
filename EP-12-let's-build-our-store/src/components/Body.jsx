    ...
    return Array.isArray(res) && res.length === 0 ? <Shimmer /> : (
        <div>
            <div className="flex m-4 p-4">
                ...
                <div className="search">
                    <input className="border-green-600 border-solid border-2 rounded-md px-2 mr-4" type="text" value={loggedInUser} onChange={(e) => {setUserName(e.target.value)}} placeholder="search..."></input>
                </div>
