                        ...
                        return (
                            <div className="flex w-full border-b-2 border-gray-200 my-2 p-6" key={card?.card?.info?.id || i}>
                                ...
                                <div className="relative">
                                    ...
                                    <button className="absolute left-7 -bottom-1.5 rounded-lg border border-gray-400 px-8 py-2 text-green-600 font-semibold bg-white bg-opacity-80 shadow-md" onClick={() => handleAddItem(card)}>Add</button>
                                </div>
                            </div>
                        );
                    }) :
                                    ...
                                    return (
                                        <div key={card?.card?.info?.id || i} className="flex justify-between w-full border-b-2 border-gray-200 p-6">
                                            ...
                                            <div className="relative">
                                                ...
                                                <button className="absolute -bottom-1.5 left-7 rounded-lg border border-gray-400 px-8 py-2 text-green-600 font-semibold bg-white bg-opacity-80 shadow-md" onClick={() => { handleAddItem(card) }}>Add</button>
                                            </div>
